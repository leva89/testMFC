...
// Experiment_MFC.cpp : Определяет поведение классов для приложения.
//
...
// Единственный объект CExperiment_MFCApp

CExperiment_MFCApp theApp;


// инициализация CExperiment_MFCApp
...
// обработчики сообщений CExperiment_MFCApp
